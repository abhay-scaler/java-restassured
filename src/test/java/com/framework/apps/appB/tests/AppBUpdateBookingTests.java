...
public class AppBUpdateBookingTests extends BaseTest {
    ...
    public void testUpdateBookingPutWithConfigDrivenBasicAuth() {
        ...
        UpdateBookingRequest updateRequest = UpdateBookingRequest.builder()
                ...
                .totalprice(250)
                .depositpaid(false)
                .bookingdates(BookingDates.builder().checkin("2026-04-02").checkout("2026-04-06").build())
                .build();
    ...
    public void testUpdateBookingPutWithExplicitTokenCookie() {
        ...
        String token = new AuthApi(unauthenticatedClient)
                .createToken(AuthRequest.builder().username("admin").password("password123").build());
        ...
        UpdateBookingRequest updateRequest = UpdateBookingRequest.builder()
                ...
                .totalprice(275)
                .depositpaid(false)
                .bookingdates(BookingDates.builder().checkin("2026-04-03").checkout("2026-04-07").build())
                .build();

        Response response = bookingApi.updateBooking(bookingId, token, updateRequest);
    ...
    @Test(groups = {"regression"}, description = "PATCH /booking/{id} partially updates only the submitted field")
    ...
    public void testPartialUpdateBookingPatchSuccess() {
        ...
        Response response = bookingApi().partialUpdateBooking(bookingId, partialRequest);
    ...
    public void testUpdateNonExistentBookingReturns405() {
        UpdateBookingRequest updateRequest = UpdateBookingRequest.builder()
                ...
                .totalprice(1)
                .depositpaid(true)
                .bookingdates(BookingDates.builder().checkin("2026-01-01").checkout("2026-01-02").build())
                .build();

        Response response = bookingApi().updateBooking(999_999_999, updateRequest);
